...
//by totsucom
#define ROTATE_CLOCKWISE_0    0
#define ROTATE_CLOCKWISE_90   1
#define ROTATE_CLOCKWISE_180  2
#define ROTATE_CLOCKWISE_270  3
...
//未完 result_t write_jpeg_streamEx(FILE *fp, image_t *img, int quality, int rotation);
